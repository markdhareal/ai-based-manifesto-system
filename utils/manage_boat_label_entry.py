...
class LabelEntryManageBoat(ctk.CTkFrame):
    ...
    def label_entry_manage_boat(self, text, row_label, cols_label,row_entry, cols_entry):
        ...
        #CREATE LAYOUT
        manage_boat_label.grid(row=row_label,column=cols_label,padx=5, pady=10,sticky="w")
        manage_boat_entry.grid(row=row_entry,column=cols_entry,padx=5,pady=10,sticky="we")